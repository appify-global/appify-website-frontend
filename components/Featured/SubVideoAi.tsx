...
const SubVideoTextAi = ({ ref }: SubVideoTextAiProps) => {
  return (
    <div className="relative z-20 w-full flex flex-col-reverse md:flex-row items-start justify-between mt-10 sm:mt-16 lg:mt-20 gap-6 sm:gap-8 lg:gap-10">
      ...
      <div className="w-full md:w-1/2 flex flex-col text-left z-10 font-Aeonik md:pt-[2rem] lg:pt-[4rem]">
        <div className="text-base sm:text-lg md:text-lg lg:text-2xl leading-relaxed">
        ...
        <div className="text-base sm:text-lg md:text-lg lg:text-2xl leading-relaxed mt-6 sm:mt-8 lg:mt-10">
