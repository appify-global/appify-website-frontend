      ...
      <div className="px-4 lg:px-20">
        ...
        {showAboutUs ? (
          ...
          >
            <h2
              ref={titleRef}
              className={`font-Aeonik text-[clamp(2.5rem,8vw,6rem)] leading-[1.1] tracking-[0.02em] uppercase mb-6 lg:mb-8 transition-all duration-700 ease-out group-hover:text-[#ff009e] ${
