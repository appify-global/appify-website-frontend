...
const FAQItemComponent: React.FC<{
  ...
  return (
    <div className="border-b border-white/10">
      ...
      >
        <div className="flex items-start lg:items-center gap-6 lg:gap-12 flex-1 pr-4">
...
export default function ServiceFAQ({ faqs }: ServiceFAQProps) {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full bg-[#121416] text-white py-14 lg:py-20 relative overflow-hidden"
    >
      {/* Decorative background text - staggered watermark */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none select-none">
        <div className="absolute top-[5%] left-[-2%] opacity-[0.03]">
          <span className="font-Aeonik text-[80px] lg:text-[180px] tracking-[0.02em] whitespace-nowrap text-white font-bold">
            FREQUENTLY
          </span>
        </div>
      ...
      <div className="px-4 lg:px-20 relative z-10">
        ...
        <h2
          ref={titleRef}
          className="font-Aeonik text-3xl lg:text-[56px] leading-[1.15] tracking-[-0.01em] mb-6 lg:mb-12 opacity-0 translate-y-8 transition-all duration-700 ease-out uppercase"
        >
