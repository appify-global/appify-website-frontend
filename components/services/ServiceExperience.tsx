...
export default function ServiceExperience({ tagline, description }: ServiceExperienceProps) {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full px-[4vw] sm:px-[6vw] lg:px-20 py-10 sm:py-12 lg:py-20"
    >
      ...
      <div className="w-full flex items-center justify-center lg:justify-between mt-8 sm:mt-10 lg:mt-20">
