...
export default function AboutPage() {
  return (
    ...
    >
      ...
      <section className="w-full bg-[var(--color-background,#F0F1FA)] pt-4 pb-4 sm:pt-5 sm:pb-5 md:pt-6 md:pb-6 lg:pt-[30px] lg:pb-[30px] relative">
          ...
          <div className="flex items-center justify-between w-full">
            {[0, 1, 2, 3].map((i) => (
              <svg
                ...
                className="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-4 md:h-4 lg:w-5 lg:h-5 text-black/60"
              >
                <path
